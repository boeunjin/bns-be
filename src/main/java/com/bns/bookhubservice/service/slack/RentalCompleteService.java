...
public class RentalCompleteService {
    ...
    public CompleteBlokitBuilder completeBlokitBuilder = new CompleteBlokitBuilder();

    public void completeMessage(String channel_id, String bookId, LocalDate end) {
    ...
    public String messageForm(String channel_id, String bookTitle, LocalDate end){
        JSONObject message1 = new JSONObject();
        //blockit builder 설정
        ArrayList<Object> blocks = completeBlokitBuilder.blockit(bookTitle, String.valueOf(end));
